"""
Contains common routines and variable definitions used by all the labs in this week.
By contrast, specific, large plotting routines will be in separate files and are generally imported into the week where they are used.
