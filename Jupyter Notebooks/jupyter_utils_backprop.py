...
def config_nw2():
    ...
    bn1 = avalue(round(dL_dd, 2), (260, 300), "green")
    bn2 = avalue(round(dL_de, 2), (270, 385), "green")
    bn3 = avalue(round(dL_df, 2), (408, 350), "green")
    bn4 = avalue(round(dL_dg, 2), (540, 350), "green")
    bn5 = avalue(round(dL_dh, 2), (650, 350), "green")
    bn6 = avalue(round(dL_di, 2), (760, 350), "green")
    bn7 = avalue(round(dL_da, 2), (890, 350), "green")
    bn8 = avalue(round(dL_dk, 2), (1015, 350), "green")
    bn9 = avalue(round(dL_dw0, 2), (210, 300), "green")
    bn10 = avalue(round(dL_dw1, 2), (205, 440), "green")
    bn11 = avalue(round(dL_db, 2), (345, 385), "green")
